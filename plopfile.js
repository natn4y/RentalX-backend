    ...
    actions: [
      {
        ...
        templateFile:
          "plop-Templates/modules/useCases/customUseCase/Controller.hbs",
        skipIfExists: true,
      },
      {
        type: "add",
        ...
        templateFile:
          "plop-Templates/modules/useCases/customUseCase/useCase.hbs",
        skipIfExists: true,
      },
      {
        type: "add",
    ...
    plop.setGenerator("Estrutura SOLID", {
      ...
      actions: [
        ...
        },
        {
          ...
          templateFile:
            "plop-Templates/modules/repositories/types/IRepository.hbs",
          skipIfExists: true,
        },
        {
          type: "add",
          ...
          templateFile:
            "plop-Templates/modules/repositories/implementations/Repository.hbs",
          skipIfExists: true,
        },
        {
          type: "add",
          ...
          templateFile:
            "plop-Templates/modules/useCases/routeName/createRouteName/CreateRouteNameController.hbs",
          skipIfExists: true,
        },
        {
          type: "add",
          ...
          templateFile:
            "plop-Templates/modules/useCases/routeName/createRouteName/CreateRouteNameUseCase.hbs",
          skipIfExists: true,
        },
        {
          type: "add",
          ...
          templateFile:
            "plop-Templates/modules/useCases/routeName/createRouteName/index.hbs",
          skipIfExists: true,
        },
        {
          type: "add",
          ...
          templateFile:
            "plop-Templates/modules/useCases/routeName/listRouteName/ListRouteNameController.hbs",
          skipIfExists: true,
        },
        {
          type: "add",
          ...
          templateFile:
            "plop-Templates/modules/useCases/routeName/listRouteName/ListRouteNameUseCase.hbs",
          skipIfExists: true,
        },
        {
          type: "add",
          ...
          templateFile:
            "plop-Templates/modules/useCases/routeName/listRouteName/index.hbs",
          skipIfExists: true,
        },
